...
PHNPC_BARKS = {
    following = {
        getText("UI_PHNPC_BarkFollowing1"),
        getText("UI_PHNPC_BarkFollowing2"),
        getText("UI_PHNPC_BarkFollowing3"),
        getText("UI_PHNPC_BarkFollowing4"),
        getText("UI_PHNPC_BarkFollowing5"),
        getText("UI_PHNPC_BarkFollowing6"),
        getText("UI_PHNPC_BarkFollowing7"),
    },
    staying = {
        getText("UI_PHNPC_BarkStaying1"),
        getText("UI_PHNPC_BarkStaying2"),
        getText("UI_PHNPC_BarkStaying3"),
        getText("UI_PHNPC_BarkStaying4"),
        getText("UI_PHNPC_BarkStaying5"),
    },
    defending = {
        getText("UI_PHNPC_BarkDefending1"),
        getText("UI_PHNPC_BarkDefending2"),
        getText("UI_PHNPC_BarkDefending3"),
        getText("UI_PHNPC_BarkDefending4"),
        getText("UI_PHNPC_BarkDefending5"),
    },
    fleeing = {
        getText("UI_PHNPC_BarkFleeing1"),
        getText("UI_PHNPC_BarkFleeing2"),
        getText("UI_PHNPC_BarkFleeing3"),
        getText("UI_PHNPC_BarkFleeing4"),
    },
    idle = {
        getText("UI_PHNPC_BarkIdle1"),
        getText("UI_PHNPC_BarkIdle2"),
        getText("UI_PHNPC_BarkIdle3"),
        getText("UI_PHNPC_BarkIdle4"),
    },
}
